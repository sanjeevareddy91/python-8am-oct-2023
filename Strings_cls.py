...
# str2 = input("Enter your sub string:") # g

# if str2 in str1:
#     which_occurence = int(input("Enter which occurence of string:"))
#     if str1.count(str2)<which_occurence:
#         print(f"{str2} has occured {str1.count(str2)} times")
#     else:
#         # index_check = 0
#         g_occurence = 1
#         for index,ele in enumerate(str1):
#             if ele == str2:
#                 if g_occurence == which_occurence:
#                     print(f"{str2}'s {which_occurence} occurence is at {index} value")
#                 g_occurence +=1
#             # index_check += 1 
# else:
